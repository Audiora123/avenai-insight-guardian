...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pre-swap risk, wallet X-ray, and live whale signals for Solana." },
      { property: "og:title", content: "Avenai — Solana wallet & token intelligence" },
      { property: "og:description", content: "Pre-swap risk, wallet X-ray, and live whale signals for Solana." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Avenai — Solana wallet & token intelligence" },
      { name: "twitter:description", content: "Pre-swap risk, wallet X-ray, and live whale signals for Solana." },
